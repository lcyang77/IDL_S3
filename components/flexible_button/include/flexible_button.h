...
#define FLEX_MS_TO_SCAN_CNT(ms) (ms)

/* Multiple clicks interval, default 300ms */
#define MAX_MULTIPLE_CLICKS_INTERVAL (FLEX_MS_TO_SCAN_CNT(350))

#ifdef CONFIG_KEY_BTN_DEBOUNCE_TICK
#define DEBOUNCE_TICK                CONFIG_KEY_BTN_DEBOUNCE_TICK
#else
#define DEBOUNCE_TICK                (FLEX_MS_TO_SCAN_CNT(20))
#endif
...
typedef struct flex_button
{
    ...
    uint16_t debounce_last_scan_cnt;
